...
const TextAnnotateBlend = (props) => {
    ...
    const handleMouseUp = () => {
        ...
        if (selection && selection.anchorNode && (selection === null || selection === void 0 ? void 0 : selection.focusNode)) {
            if (selectionIsEmpty(selection))
                return;
            let startBase = (_a = selection.anchorNode.parentElement) === null || _a === void 0 ? void 0 : _a.getAttribute("data-start");
            let endBase = (_b = selection.focusNode.parentElement) === null || _b === void 0 ? void 0 : _b.getAttribute("data-start");
